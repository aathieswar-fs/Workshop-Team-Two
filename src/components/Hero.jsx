export default function Hero() {
  return (
    ...
    //   <button className="bg-purple-700 text-white px-6 py-3 rounded-full hover:bg-purple-600">
    //     View My Work
    //   </button>
    // </section>
...
{/* 
      ...
      <section className="relative py-2 sm:py-4 lg:pt-8 lg:pb-16">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 gap-y-8 lg:items-center lg:grid-cols-2 sm:gap-y-20 xl:grid-cols-5">
            <div className="text-center xl:col-span-2 lg:text-left md:px-16 lg:px-0">
              <div className="max-w-sm mx-auto sm:max-w-md md:max-w-full">
                <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight font-pj">
                  Hi, I'm Kenny, a Passionate Web Developer
                </h1>

                <p className="mt-4 text-lg text-gray-600">
                  I specialize in creating dynamic, responsive websites and applications using modern web technologies like React, Next.js, and the MERN stack.
                </p>
                ...
                <div className="mt-8 lg:mt-12 lg:flex lg:items-center">
                  <div className="flex justify-center flex-shrink-0 -space-x-4 overflow-hidden lg:justify-start">
                    ...
                    /> */}
                    <img width="80" height="80" src="https://img.icons8.com/dotty/80/teamwork.png" alt="teamwork"/>
                  </div>
